...
--
main = do
  xmproc <- spawnPipe "xmobar /home/hasnatdev/.config/xmobar/xmobarrc"
...
help = unlines ["The default modifier key is 'alt'. Default keybindings:",
    ...
    "mod-Shift-l  Swap the focused window with the previous window",
    "",
    "-- resizing the master/slave ratio",
    "mod-u  Shrink the master area",
    ...
    "mod-x        Restart xmonad",
    "mod-[1..9]   Switch to workSpace N",
    "",
    "-- Workspaces & screens",
    "mod-Shift-[1..9]   Move client to workspace N",
    "mod-{w,e,t}        Switch to physical/Xinerama screens 1, 2, or 3",
    "mod-Shift-{w,e,r}  Move client to screen 1, 2, or 3",
    "",
    "-- Mouse bindings: default actions bound to mouse events",
    "mod-button1  Set the window to floating mode and move by dragging",
